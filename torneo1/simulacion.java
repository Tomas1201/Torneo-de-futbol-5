...
public class TorneoFutbol {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cantidadPartidos; i++) {
            ...
            int golesLocal = generarNumeroAleatorio(0, 5); // Generar un número aleatorio de goles para el equipo local
            int golesVisitante = generarNumeroAleatorio(0, 5); // Generar un número aleatorio de goles para el equipo visitante
